...
type ServerInterface interface {
	// return message
	// (GET /goodMorning)
	GoodMorning(ctx echo.Context) error
	// return message
	// (GET /hello)
...
// GoodMorning converts echo context to params.
func (w *ServerInterfaceWrapper) GoodMorning(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.GoodMorning(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/goodMorning", wrapper.GoodMorning)
